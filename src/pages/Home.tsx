            ...
            {ads.map((ticket) => (
              <div key={ticket._id} className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 rounded-3xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-between">
                <div className="relative overflow-hidden">
                  ...
                  <span className="absolute top-4 right-4 bg-yellow-500 text-slate-950 text-[10px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider shadow-md">AD</span>
                </div>
            ...
            {latest.map((ticket) => (
              <div key={ticket._id} className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 rounded-3xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-between">
                ...
                <div className="p-6 space-y-4 flex-grow flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap pt-2">
                    {ticket.perks.slice(0, 3).map((p, idx) => (
                      <span key={idx} className="bg-slate-50 dark:bg-slate-800/60 text-slate-600 dark:text-slate-355 border border-slate-100 dark:border-slate-800/50 text-[10px] font-bold px-2.5 py-1 rounded-lg">{p}</span>
                    ))}
                  </div>
                  <div className="flex items-center justify-between border-t border-slate-100 dark:border-slate-800/60 pt-4 mt-4">
                    <div>
